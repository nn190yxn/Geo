...
- `requirements.md`：品牌资料、监测、内容发布、分析诊断和全局用词需求，并补充快速接入、探测题隔离、样本回放、测量纪律、机会验证、引用吸收、内容质量、资料检索、周期交付、运行治理和公开品牌档案需求
- `design.md`：闭环信息架构、页面设计、GeoLook 与 GEORank 深度能力映射、快速接入、真实再次监测、版本化诊断、周期报告、效果归因、Provider 成本事务、客户交付和公开品牌资产设计
- `tasklist.md`：产品体验精修实施清单，当前已完成第一阶段体验与闭环整改、第二阶段可信度版本、官网快速接入、站点审计、任务 checker、可部署技术资产、审计工作台、专项测试、版本化诊断评分、验收进度快照、历史证据、回归重开、P18/P19 属性测试、运行与样本级测量条件、指标到原始样本的证据查询、可比基线和观察归因、八维问题拓展与确定性降级、竞品主题和真实信源渠道地图、P13/P14 测量与机会专项测试、品牌探测题与跨访问端指标隔离、未测权重归一、平台比较门禁、连续趋势状态、待补测验收、竞品候选四态证据生命周期、问题机会和 Top 3 平台、搜索补全需求快照、需求上升观察、人工入库、渠道建设蓝图和 30/60/90 路线图、P20-P23 高级测量属性测试、内容发布准备检查、发布确认和真实结果记录、Provider 池与组织 BYOK、额度预占与结算、品牌资料片段、来源版本、带证据问答、效果归因、引用吸收、对比榜单 FAQ 专属内容门禁、检索连续性和 BYOK 成本边界、组织和品牌隔离的关键步骤产品事件采集、按统计周期输出六项漏斗指标、样本规模、分母定义和数据缺口的产品效果聚合看板，以及事件和效果聚合专项测试；下一项为持久化异步任务编排
